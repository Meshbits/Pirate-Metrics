...
func ZecBtcBinanceAPI(wg *sync.WaitGroup) {
	...
	// Forever loop to keep fetching rates every N seconds
	for {
		url := "https://api.binance.com/api/v3/trades?symbol=ZECBTC"
		params := ``
		result, err := RPCResultMap(url, params)
		if err != nil {
			log.Printf("Got error fetching Binance ZEC/BTC rates: %v\n", err)
		}
		// fmt.Println(result)
		...
		if resultType != "[]interface {}" {
			...
			zecBtcPrice, _ := strconv.ParseFloat(result.([]interface{})[0].(map[string]interface{})["price"].(string), 64)
			zecUSDPrice := zecBtcPrice * BTC_RATES.Rates.USD
			// fmt.Println("==========================")
			// fmt.Printf("ZEC Price (BTC): %.8f\n", zecBtcPrice)
			// fmt.Printf("ZEC Price (USD): %.6f\n", zecUSDPrice)
			// fmt.Println("==========================")
			var zec ConversionRates
			zec.Timestamp = int64(result.([]interface{})[0].(map[string]interface{})["time"].(float64))
			zec.Base = "ZEC/BTC"
			zec.Market = "Binance"
			zec.Rates.AED = toFixed(FIXER_RATES.Rates.AED*zecBtcPrice, 6)
			zec.Rates.AFN = toFixed(FIXER_RATES.Rates.AFN*zecBtcPrice, 6)
			zec.Rates.ALL = toFixed(FIXER_RATES.Rates.ALL*zecBtcPrice, 6)
			zec.Rates.AMD = toFixed(FIXER_RATES.Rates.AMD*zecBtcPrice, 6)
			zec.Rates.ANG = toFixed(FIXER_RATES.Rates.ANG*zecBtcPrice, 6)
			zec.Rates.AOA = toFixed(FIXER_RATES.Rates.AOA*zecBtcPrice, 6)
			zec.Rates.ARS = toFixed(FIXER_RATES.Rates.ARS*zecBtcPrice, 6)
			zec.Rates.AUD = toFixed(FIXER_RATES.Rates.AUD*zecBtcPrice, 6)
			zec.Rates.AWG = toFixed(FIXER_RATES.Rates.AWG*zecBtcPrice, 6)
			zec.Rates.AZN = toFixed(FIXER_RATES.Rates.AZN*zecBtcPrice, 6)
			zec.Rates.BAM = toFixed(FIXER_RATES.Rates.BAM*zecBtcPrice, 6)
			zec.Rates.BBD = toFixed(FIXER_RATES.Rates.BBD*zecBtcPrice, 6)
			zec.Rates.BDT = toFixed(FIXER_RATES.Rates.BDT*zecBtcPrice, 6)
			zec.Rates.BGN = toFixed(FIXER_RATES.Rates.BGN*zecBtcPrice, 6)
			zec.Rates.BHD = toFixed(FIXER_RATES.Rates.BHD*zecBtcPrice, 6)
			zec.Rates.BIF = toFixed(FIXER_RATES.Rates.BIF*zecBtcPrice, 6)
			zec.Rates.BMD = toFixed(zecUSDPrice, 6)
			zec.Rates.BND = toFixed(FIXER_RATES.Rates.BND*zecBtcPrice, 6)
			zec.Rates.BOB = toFixed(FIXER_RATES.Rates.BOB*zecBtcPrice, 6)
			zec.Rates.BRL = toFixed(FIXER_RATES.Rates.BRL*zecBtcPrice, 6)
			zec.Rates.BSD = toFixed(FIXER_RATES.Rates.BSD*zecBtcPrice, 6)
			zec.Rates.BTC = toFixed(zecBtcPrice, 8)
			zec.Rates.BTN = toFixed(FIXER_RATES.Rates.BTN*zecBtcPrice, 6)
			zec.Rates.BWP = toFixed(FIXER_RATES.Rates.BWP*zecBtcPrice, 6)
			zec.Rates.BYN = toFixed(FIXER_RATES.Rates.BYN*zecBtcPrice, 6)
			zec.Rates.BYR = toFixed(FIXER_RATES.Rates.BYR*zecBtcPrice, 6)
			zec.Rates.BZD = toFixed(FIXER_RATES.Rates.BZD*zecBtcPrice, 6)
			zec.Rates.CAD = toFixed(FIXER_RATES.Rates.CAD*zecBtcPrice, 6)
			zec.Rates.CDF = toFixed(FIXER_RATES.Rates.CDF*zecBtcPrice, 6)
			zec.Rates.CHF = toFixed(FIXER_RATES.Rates.CHF*zecBtcPrice, 6)
			zec.Rates.CLF = toFixed(FIXER_RATES.Rates.CLF*zecBtcPrice, 6)
			zec.Rates.CLP = toFixed(FIXER_RATES.Rates.CLP*zecBtcPrice, 6)
			zec.Rates.CNY = toFixed(FIXER_RATES.Rates.CNY*zecBtcPrice, 6)
			zec.Rates.COP = toFixed(FIXER_RATES.Rates.COP*zecBtcPrice, 6)
			zec.Rates.CRC = toFixed(FIXER_RATES.Rates.CRC*zecBtcPrice, 6)
			zec.Rates.CUC = toFixed(zecUSDPrice, 6)
			zec.Rates.CUP = toFixed(FIXER_RATES.Rates.CUP*zecBtcPrice, 6)
			zec.Rates.CVE = toFixed(FIXER_RATES.Rates.CVE*zecBtcPrice, 6)
			zec.Rates.CZK = toFixed(FIXER_RATES.Rates.CZK*zecBtcPrice, 6)
			zec.Rates.DJF = toFixed(FIXER_RATES.Rates.DJF*zecBtcPrice, 6)
			zec.Rates.DKK = toFixed(FIXER_RATES.Rates.DKK*zecBtcPrice, 6)
			zec.Rates.DOP = toFixed(FIXER_RATES.Rates.DOP*zecBtcPrice, 6)
			zec.Rates.DZD = toFixed(FIXER_RATES.Rates.DZD*zecBtcPrice, 6)
			zec.Rates.EGP = toFixed(FIXER_RATES.Rates.EGP*zecBtcPrice, 6)
			zec.Rates.ERN = toFixed(FIXER_RATES.Rates.ERN*zecBtcPrice, 6)
			zec.Rates.ETB = toFixed(FIXER_RATES.Rates.ETB*zecBtcPrice, 6)
			zec.Rates.EUR = toFixed(FIXER_RATES.Rates.EUR*zecBtcPrice, 6)
			zec.Rates.FJD = toFixed(FIXER_RATES.Rates.FJD*zecBtcPrice, 6)
			zec.Rates.FKP = toFixed(FIXER_RATES.Rates.FKP*zecBtcPrice, 6)
			zec.Rates.GBP = toFixed(FIXER_RATES.Rates.GBP*zecBtcPrice, 6)
			zec.Rates.GEL = toFixed(FIXER_RATES.Rates.GEL*zecBtcPrice, 6)
			zec.Rates.GGP = toFixed(FIXER_RATES.Rates.GGP*zecBtcPrice, 6)
			zec.Rates.GHS = toFixed(FIXER_RATES.Rates.GHS*zecBtcPrice, 6)
			zec.Rates.GIP = toFixed(FIXER_RATES.Rates.GIP*zecBtcPrice, 6)
			zec.Rates.GMD = toFixed(FIXER_RATES.Rates.GMD*zecBtcPrice, 6)
			zec.Rates.GNF = toFixed(FIXER_RATES.Rates.GNF*zecBtcPrice, 6)
			zec.Rates.GTQ = toFixed(FIXER_RATES.Rates.GTQ*zecBtcPrice, 6)
			zec.Rates.GYD = toFixed(FIXER_RATES.Rates.GYD*zecBtcPrice, 6)
			zec.Rates.HKD = toFixed(FIXER_RATES.Rates.HKD*zecBtcPrice, 6)
			zec.Rates.HNL = toFixed(FIXER_RATES.Rates.HNL*zecBtcPrice, 6)
			zec.Rates.HRK = toFixed(FIXER_RATES.Rates.HRK*zecBtcPrice, 6)
			zec.Rates.HTG = toFixed(FIXER_RATES.Rates.HTG*zecBtcPrice, 6)
			zec.Rates.HUF = toFixed(FIXER_RATES.Rates.HUF*zecBtcPrice, 6)
			zec.Rates.IDR = toFixed(FIXER_RATES.Rates.IDR*zecBtcPrice, 6)
			zec.Rates.ILS = toFixed(FIXER_RATES.Rates.ILS*zecBtcPrice, 6)
			zec.Rates.IMP = toFixed(FIXER_RATES.Rates.IMP*zecBtcPrice, 6)
			zec.Rates.INR = toFixed(FIXER_RATES.Rates.INR*zecBtcPrice, 6)
			zec.Rates.IQD = toFixed(FIXER_RATES.Rates.IQD*zecBtcPrice, 6)
			zec.Rates.IRR = toFixed(FIXER_RATES.Rates.IRR*zecBtcPrice, 6)
			zec.Rates.ISK = toFixed(FIXER_RATES.Rates.ISK*zecBtcPrice, 6)
			zec.Rates.JEP = toFixed(FIXER_RATES.Rates.JEP*zecBtcPrice, 6)
			zec.Rates.JMD = toFixed(FIXER_RATES.Rates.JMD*zecBtcPrice, 6)
			zec.Rates.JOD = toFixed(FIXER_RATES.Rates.JOD*zecBtcPrice, 6)
			zec.Rates.JPY = toFixed(FIXER_RATES.Rates.JPY*zecBtcPrice, 6)
			zec.Rates.KES = toFixed(FIXER_RATES.Rates.KES*zecBtcPrice, 6)
			zec.Rates.KGS = toFixed(FIXER_RATES.Rates.KGS*zecBtcPrice, 6)
			zec.Rates.KHR = toFixed(FIXER_RATES.Rates.KHR*zecBtcPrice, 6)
			zec.Rates.KMF = toFixed(FIXER_RATES.Rates.KMF*zecBtcPrice, 6)
			zec.Rates.KPW = toFixed(FIXER_RATES.Rates.KPW*zecBtcPrice, 6)
			zec.Rates.KRW = toFixed(FIXER_RATES.Rates.KRW*zecBtcPrice, 6)
			zec.Rates.KWD = toFixed(FIXER_RATES.Rates.KWD*zecBtcPrice, 6)
			zec.Rates.KYD = toFixed(FIXER_RATES.Rates.KYD*zecBtcPrice, 6)
			zec.Rates.KZT = toFixed(FIXER_RATES.Rates.KZT*zecBtcPrice, 6)
			zec.Rates.LAK = toFixed(FIXER_RATES.Rates.LAK*zecBtcPrice, 6)
			zec.Rates.LBP = toFixed(FIXER_RATES.Rates.LBP*zecBtcPrice, 6)
			zec.Rates.LKR = toFixed(FIXER_RATES.Rates.LKR*zecBtcPrice, 6)
			zec.Rates.LRD = toFixed(FIXER_RATES.Rates.LRD*zecBtcPrice, 6)
			zec.Rates.LSL = toFixed(FIXER_RATES.Rates.LSL*zecBtcPrice, 6)
			zec.Rates.LTL = toFixed(FIXER_RATES.Rates.LTL*zecBtcPrice, 6)
			zec.Rates.LVL = toFixed(FIXER_RATES.Rates.LVL*zecBtcPrice, 6)
			zec.Rates.LYD = toFixed(FIXER_RATES.Rates.LYD*zecBtcPrice, 6)
			zec.Rates.MAD = toFixed(FIXER_RATES.Rates.MAD*zecBtcPrice, 6)
			zec.Rates.MDL = toFixed(FIXER_RATES.Rates.MDL*zecBtcPrice, 6)
			zec.Rates.MGA = toFixed(FIXER_RATES.Rates.MGA*zecBtcPrice, 6)
			zec.Rates.MKD = toFixed(FIXER_RATES.Rates.MKD*zecBtcPrice, 6)
			zec.Rates.MMK = toFixed(FIXER_RATES.Rates.MMK*zecBtcPrice, 6)
			zec.Rates.MNT = toFixed(FIXER_RATES.Rates.MNT*zecBtcPrice, 6)
			zec.Rates.MOP = toFixed(FIXER_RATES.Rates.MOP*zecBtcPrice, 6)
			zec.Rates.MRO = toFixed(FIXER_RATES.Rates.MRO*zecBtcPrice, 6)
			zec.Rates.MUR = toFixed(FIXER_RATES.Rates.MUR*zecBtcPrice, 6)
			zec.Rates.MVR = toFixed(FIXER_RATES.Rates.MVR*zecBtcPrice, 6)
			zec.Rates.MWK = toFixed(FIXER_RATES.Rates.MWK*zecBtcPrice, 6)
			zec.Rates.MXN = toFixed(FIXER_RATES.Rates.MXN*zecBtcPrice, 6)
			zec.Rates.MYR = toFixed(FIXER_RATES.Rates.MYR*zecBtcPrice, 6)
			zec.Rates.MZN = toFixed(FIXER_RATES.Rates.MZN*zecBtcPrice, 6)
			zec.Rates.NAD = toFixed(FIXER_RATES.Rates.NAD*zecBtcPrice, 6)
			zec.Rates.NGN = toFixed(FIXER_RATES.Rates.NGN*zecBtcPrice, 6)
			zec.Rates.NIO = toFixed(FIXER_RATES.Rates.NIO*zecBtcPrice, 6)
			zec.Rates.NOK = toFixed(FIXER_RATES.Rates.NOK*zecBtcPrice, 6)
			zec.Rates.NPR = toFixed(FIXER_RATES.Rates.NPR*zecBtcPrice, 6)
			zec.Rates.NZD = toFixed(FIXER_RATES.Rates.NZD*zecBtcPrice, 6)
			zec.Rates.OMR = toFixed(FIXER_RATES.Rates.OMR*zecBtcPrice, 6)
			zec.Rates.PAB = toFixed(FIXER_RATES.Rates.PAB*zecBtcPrice, 6)
			zec.Rates.PEN = toFixed(FIXER_RATES.Rates.PEN*zecBtcPrice, 6)
			zec.Rates.PGK = toFixed(FIXER_RATES.Rates.PGK*zecBtcPrice, 6)
			zec.Rates.PHP = toFixed(FIXER_RATES.Rates.PHP*zecBtcPrice, 6)
			zec.Rates.PKR = toFixed(FIXER_RATES.Rates.PKR*zecBtcPrice, 6)
			zec.Rates.PLN = toFixed(FIXER_RATES.Rates.PLN*zecBtcPrice, 6)
			zec.Rates.PYG = toFixed(FIXER_RATES.Rates.PYG*zecBtcPrice, 6)
			zec.Rates.QAR = toFixed(FIXER_RATES.Rates.QAR*zecBtcPrice, 6)
			zec.Rates.RON = toFixed(FIXER_RATES.Rates.RON*zecBtcPrice, 6)
			zec.Rates.RSD = toFixed(FIXER_RATES.Rates.RSD*zecBtcPrice, 6)
			zec.Rates.RUB = toFixed(FIXER_RATES.Rates.RUB*zecBtcPrice, 6)
			zec.Rates.RWF = toFixed(FIXER_RATES.Rates.RWF*zecBtcPrice, 6)
			zec.Rates.SAR = toFixed(FIXER_RATES.Rates.SAR*zecBtcPrice, 6)
			zec.Rates.SBD = toFixed(FIXER_RATES.Rates.SBD*zecBtcPrice, 6)
			zec.Rates.SCR = toFixed(FIXER_RATES.Rates.SCR*zecBtcPrice, 6)
			zec.Rates.SDG = toFixed(FIXER_RATES.Rates.SDG*zecBtcPrice, 6)
			zec.Rates.SEK = toFixed(FIXER_RATES.Rates.SEK*zecBtcPrice, 6)
			zec.Rates.SGD = toFixed(FIXER_RATES.Rates.SGD*zecBtcPrice, 6)
			zec.Rates.SHP = toFixed(FIXER_RATES.Rates.SHP*zecBtcPrice, 6)
			zec.Rates.SLL = toFixed(FIXER_RATES.Rates.SLL*zecBtcPrice, 6)
			zec.Rates.SOS = toFixed(FIXER_RATES.Rates.SOS*zecBtcPrice, 6)
			zec.Rates.SRD = toFixed(FIXER_RATES.Rates.SRD*zecBtcPrice, 6)
			zec.Rates.STD = toFixed(FIXER_RATES.Rates.STD*zecBtcPrice, 6)
			zec.Rates.SVC = toFixed(FIXER_RATES.Rates.SVC*zecBtcPrice, 6)
			zec.Rates.SYP = toFixed(FIXER_RATES.Rates.SYP*zecBtcPrice, 6)
			zec.Rates.SZL = toFixed(FIXER_RATES.Rates.SZL*zecBtcPrice, 6)
			zec.Rates.THB = toFixed(FIXER_RATES.Rates.THB*zecBtcPrice, 6)
			zec.Rates.TJS = toFixed(FIXER_RATES.Rates.TJS*zecBtcPrice, 6)
			zec.Rates.TMT = toFixed(FIXER_RATES.Rates.TMT*zecBtcPrice, 6)
			zec.Rates.TND = toFixed(FIXER_RATES.Rates.TND*zecBtcPrice, 6)
			zec.Rates.TOP = toFixed(FIXER_RATES.Rates.TOP*zecBtcPrice, 6)
			zec.Rates.TRY = toFixed(FIXER_RATES.Rates.TRY*zecBtcPrice, 6)
			zec.Rates.TTD = toFixed(FIXER_RATES.Rates.TTD*zecBtcPrice, 6)
			zec.Rates.TWD = toFixed(FIXER_RATES.Rates.TWD*zecBtcPrice, 6)
			zec.Rates.TZS = toFixed(FIXER_RATES.Rates.TZS*zecBtcPrice, 6)
			zec.Rates.UAH = toFixed(FIXER_RATES.Rates.UAH*zecBtcPrice, 6)
			zec.Rates.UGX = toFixed(FIXER_RATES.Rates.UGX*zecBtcPrice, 6)
			zec.Rates.USD = toFixed(zecUSDPrice, 6)
			zec.Rates.UYU = toFixed(FIXER_RATES.Rates.UYU*zecBtcPrice, 6)
			zec.Rates.UZS = toFixed(FIXER_RATES.Rates.UZS*zecBtcPrice, 6)
			zec.Rates.VEF = toFixed(FIXER_RATES.Rates.VEF*zecBtcPrice, 6)
			zec.Rates.VND = toFixed(FIXER_RATES.Rates.VND*zecBtcPrice, 6)
			zec.Rates.VUV = toFixed(FIXER_RATES.Rates.VUV*zecBtcPrice, 6)
			zec.Rates.WST = toFixed(FIXER_RATES.Rates.WST*zecBtcPrice, 6)
			zec.Rates.XAF = toFixed(FIXER_RATES.Rates.XAF*zecBtcPrice, 6)
			zec.Rates.XAG = toFixed(FIXER_RATES.Rates.XAG*zecBtcPrice, 6)
			zec.Rates.XAU = toFixed(FIXER_RATES.Rates.XAU*zecBtcPrice, 6)
			zec.Rates.XCD = toFixed(FIXER_RATES.Rates.XCD*zecBtcPrice, 6)
			zec.Rates.XDR = toFixed(FIXER_RATES.Rates.XDR*zecBtcPrice, 6)
			zec.Rates.XOF = toFixed(FIXER_RATES.Rates.XOF*zecBtcPrice, 6)
			zec.Rates.XPF = toFixed(FIXER_RATES.Rates.XPF*zecBtcPrice, 6)
			zec.Rates.YER = toFixed(FIXER_RATES.Rates.YER*zecBtcPrice, 6)
			zec.Rates.ZAR = toFixed(FIXER_RATES.Rates.ZAR*zecBtcPrice, 6)
			zec.Rates.ZMK = toFixed(FIXER_RATES.Rates.ZMK*zecBtcPrice, 6)
			zec.Rates.ZMW = toFixed(FIXER_RATES.Rates.ZMW*zecBtcPrice, 6)
			zec.Rates.ZWL = toFixed(FIXER_RATES.Rates.ZWL*zecBtcPrice, 6)

			ZEC_BTC_BINANCE_RATES = zec
